...
class NeuronWorker:
    ...
    def determine_available_memory(self) -> int:
        # TODO(aoyu): use neuron_runtime_memory_info()
        # return fake 1 GB in bytes
        neuron_kv_cache_bytes = 1024 * 1024 * 1024
        return neuron_kv_cache_bytes
    ...
    def initialize_cache(self, num_tpu_blocks: int) -> None:
        ...
        # HACK AOYU disable the memory check for TPU device
        # # Get the maximum amount of memory used by the model weights and
        # # intermediate activations.
        # xm.mark_step()
        # xm.wait_device_ops()
